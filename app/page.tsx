          ...
          <div className="bg-[#0b0f1a] rounded-[14px] p-6 text-center border border-gray-800/50 backdrop-blur-xl">
            {!user ? (
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-white hover:bg-gray-100 transition rounded-xl text-black font-bold shadow-lg active:scale-[0.98]"
              >
                {/* --- GOOGLE LOGO SVG --- */}
